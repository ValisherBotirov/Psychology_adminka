  ...
  <div>
      ...
      <table class="w-full text-sm text-left text-gray-500 mt-4">
          ...
          >
              ...
              <th class="test-name px-6 py-4 font-medium text-gray-900 whitespace-nowrap max-w-[350px] break-words overflow-x-scroll">
                  {{ item?.name }}
              </th>
              ...
              <td class="flex items-center px-6 py-4 space-x-4 justify-end">
                  <div class="cursor-pointer hover:text-blue-700 font-medium">
                  </div>
                  <div
                      @click="editTest(item)"
                  ...
                  <DeleteModal :isOpen="openDeleteModal" @closeModal="e => openDeleteModal = e" @delete="deleteTest"/>
              </td>
          </tr>
          </tbody>
      </table>
