    ...
    >
      <div>
        ...
        <div class="flex gap-4 mt-3">
          ...
          <Textarea
            :error="$vSubcategory.mark2.$error"
            v-model="formSubcategory.mark2"
            custom-class="!h-[40px] py-1"
            class="w-full"
            placeholder="Sharhni yozing"
            l
        ...
        <div class="flex gap-4 mt-3">
          ...
          <Textarea
            :error="$vSubcategory.mark3.$error"
            v-model="formSubcategory.mark3"
            custom-class="!h-[40px] py-1"
            class="w-full"
            placeholder="Sharhni yozing"
            l
        ...
        <div class="flex gap-4 mt-3">
          ...
          <Textarea
            :error="$vSubcategory.mark4.$error"
            v-model="formSubcategory.mark4"
            custom-class="!h-[40px] py-1"
            class="w-full"
            placeholder="Sharhni yozing"
            l
        ...
        <div class="flex gap-4 mt-3">
          ...
          <Textarea
            :error="$vSubcategory.mark5.$error"
            v-model="formSubcategory.mark5"
            custom-class="!h-[40px] py-1"
            class="w-full"
            placeholder="Sharhni yozing"
            l
      ...
      axios
        ...
        .finally(() => {
          (formSubcategory.title = ""),
            ...
            (formSubcategory.mark2 = ""),
            (formSubcategory.mark3 = ""),
            (formSubcategory.mark4 = ""),
            (formSubcategory.mark5 = ""),
